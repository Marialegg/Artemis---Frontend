...
<div id="style-switcher" style="left: 0px;" class="bg-light border p-3 pt-2 pb-2" v-bind:style="isVisible ? 'left: 0px' : 'left: -189px'">
   <h6 class="title text-center">Select Your Color</h6>
    ...
    <div class="text-center">
        ...
        <a href="javascript: void(0);" class="btn btn-sm w-100 btn-dark dark-version t-dark mt-2" @click="setDark(), dark=true">Dark</a>
        <a href="javascript: void(0);" class="btn btn-sm w-100 btn-dark light-version t-light mt-2" @click="setLight(), dark=false">Light</a>
    </div>
    <div class="bottom">
