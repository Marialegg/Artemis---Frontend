      ...
      <div class="container-fluid">
        <div class="d-lg-flex justify-content-between">
          ...
          <div class="col d-lg-flex justify-content-end">
            ...
            <div id="navigation">
              ...
              >
                ...
                <li
                  class="d-block d-lg-none"
                  v-if="darktheme"
                  @click="setLight(), (darktheme = false)"
                >
                  <a class="side-nav-link-ref">
                    Light Mode
                  </a>
                ...
                <li>
                  <router-link to="/" class="side-nav-link-ref text-dark">
                    Activity
                  </router-link>
                </li>
              </ul>
            ...
            <ul class="buy-button d-none d-lg-block">
              <svg
                v-if="darktheme"
                @click="setLight(), (darktheme = false)"
            ...
            <ul class="buy-button d-none d-lg-block" v-if="isIcons === true">
            ...
            Connect Wallet</router-link   -->
              ...
              <b-dropdown
                ...
                :text="user"
                class="btn p-0 p-0"
                style="font-size: 11px; font-weight: 600; float: center"
                variant="dark"
                v-show="sesion"
              >
                <b-dropdown-item to="/collection"
                  >My Collections</b-dropdown-item
                >
                <b-dropdown-item to="/collection"
                  >New Collection</b-dropdown-item
                >
                <b-dropdown-item to="/collection"
                  >New Publication</b-dropdown-item
                >
                <b-dropdown-divider></b-dropdown-divider>
                <b-dropdown-item @click="loginNear">Logout</b-dropdown-item>
              </b-dropdown>
            </ul>
          </div>
        </div>
